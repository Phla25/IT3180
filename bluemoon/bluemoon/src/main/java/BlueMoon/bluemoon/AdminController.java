...
public class AdminController {
    ...
    */
    ...
    @GetMapping("/notifications/{id}/replies")
    @ResponseBody
    public List<PhanHoiThongBaoDTO> getReplies(@PathVariable("id") Integer id) {
        return thongBaoService.getPhanHoiDTOByThongBao(id);
    }
